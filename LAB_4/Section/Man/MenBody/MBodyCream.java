...
import java.io.*;  
public class MBodyCream extends Body implements Serializable{
	private String _size;
	private String color;
	private String company_name;
	private String type;

	public MBodyCream(String string, String string2, int i, String string3, String string4, String string5,
            String string6) {
    }
